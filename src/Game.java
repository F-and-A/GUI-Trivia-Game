...
public class Game extends JFrame {
    //Creates static references to be use later
    ...
    public void trivia() {
        ...
        // Action Listener is added to Button 3
        ...
        // Action Listener is added to Button 4
    ...
    //Questions Screen where the main game happens
    public static void QuestionsScreen() {
        //After all questions end game
        if (QuestionLevel == 3) {
            EndScreen();
        }
    ...
    //End screen writes a congratulation message and has a back button to the menu
    ...
    //Used to set question and score
